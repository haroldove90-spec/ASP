          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-7 bg-white border border-slate-200 rounded-xl p-5 shadow-sm space-y-4">
              ...
              <div className="grid grid-cols-7 gap-1.5 min-h-[220px]">
                {/* Empty days up to Wednesday July 1st */}
                ...
                {Array.from({ length: 31 }).map((_, idx) => {
                  ...
                  return (
                    <div 
                      key={day} 
                      className={`border border-slate-100 rounded-lg p-1 min-h-[50px] flex flex-col justify-between hover:border-slate-300 transition-colors ${
                        servicesThisDay.length > 0 ? 'bg-emerald-50/20 border-emerald-200' : 'bg-white'
                      }`}
                    >
                        ...
                        {servicesThisDay.map((serv, sIdx) => {
                          ...
                          return (
                            <div 
                              ...
                              className="text-[8px] font-sans bg-emerald-600 text-white rounded px-1 py-0.5 font-semibold truncate leading-tight"
                            >
                              {serv.cliente_nombre.substring(0, 10)}
                            </div>
                          );
                        })}
                      </div>
            ...
            <div className="lg:col-span-5 bg-slate-900 text-white rounded-xl p-5 border border-slate-800 space-y-4">
              ...
              <p className="text-[11px] text-slate-400 leading-relaxed font-light">
                Asigne un nuevo servicio de levantamiento. El sistema verificará de manera automática si el técnico tiene un check-in metrológico y si el instrumento seleccionado cuenta con calibración vigente bajo la norma NMX-EC-17025.
              </p>
              ...
              <form onSubmit={handleAssignService} className="space-y-4 text-xs">
                ...
                >
                  ...
                  <span>Programar Asignación en Planta</span>
                </button>
              </form>
            </div>
          </div>
